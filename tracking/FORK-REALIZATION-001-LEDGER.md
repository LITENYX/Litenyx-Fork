...
| **Verification**  | [VERIFIED] Local toolchain build complete + daemon executes (exit 0). [VERIFIED] Independent Linux CI: build + C++ KATs + regtest acceptance + INT-OPEN-1/M3 gate all SUCCESS. Evidence: run 36142281332 (Litenyx CI), 36142281228 (M3), 36142281365 (C++ tests). |
...
| **Commit**        | `4292373598eac9681d6814806a1ed66b31e206be` (branch `fork-realization-001-f1-build`, pushed to origin, PR #10). |
